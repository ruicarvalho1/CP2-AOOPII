...
const updateFields = () => {
  if (props.auction) {
    ...
    isAuctionStarted.value = props.auction.internal_info?.auction_started || false;
  }
};
...
const endAuction = async () => {
  try {
    ...
    const response = await fetch(`https://project-assignment-2-27638-27628-27643-3dd5.onrender.com/auth/auction/${props.auction._id}/end`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
