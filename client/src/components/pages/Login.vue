...
const validate_login = () => {
    //VALIDACAO DE LOGIN RETORNA TRUE OU FALSE PARA A CLASSE SER APLICADA NO ELEMENTO DE ERRO
  ref(false);
};
</script>
    ...
    <div class="login-form">
      <div class="form">
        ...
        <div class="username">
          ...
          <input class="login-input" type="text" placeholder="Nome utilizador">
        </div>
        <div class="password">
          <h3>Palavra-passe:</h3>
          <input class="login-input" type="password" placeholder="●●●●●●●●">
        </div>
        <div :class="{ 'raise-error': validate_login}" class="error">
          <h5>Início de sessão falhou, nome de utilizador e palavra passe não correspondem</h5>
        </div>
        <button class="login-btn">Iniciar sessão</button>
      </div>
...
<style scoped>
  ...
  .login-page .login-form .raise-error.error {
    display: flex;
  }
